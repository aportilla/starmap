...
Body brightness is **not** modulated by a stored albedo scalar — reflectance emerges from resource composition + water + ice + biome + cratering + linea + the atmospheric layers above.
