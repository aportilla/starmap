...
- `temperate_gaseous` — gaseous default → NH3 clouds (Jupiter-class); NH4SH haze added separately by `hazeContribution`'s NH3+temp gate when conditions support cloud-top sulfide chemistry
